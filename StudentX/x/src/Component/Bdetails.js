 ...
 function Bdetails(){
    ...
    return(
      ...
      <div className="relative max-w-xl mx-auto">
        ...
        <div className="bg-gray-100  overflow-hidden  lg:py-24 ">
             <div className="relative mx-auto">
              <div className="text-left">
                 <h2 className="text-1xl font-extra tracking-tight text-gray-900 sm:text-3xl">Basic Information</h2>
              </div>
             </div>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-1">
                <input
                  ...
                  type="email"
                  autoComplete="email"
                  className="ml-2 py-3 px-4 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md"
                />
              </div>
            </div>
            <div className="sm:col-span-2">
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  id="DOV"
                  autoComplete="tel"
                  className="py-3 px-4 block w-full pl-5 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md"
